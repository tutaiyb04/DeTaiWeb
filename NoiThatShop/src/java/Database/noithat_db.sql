...
(1, 'tutai', 'Từ Tú Tài', 'tutaiyb2411@gmail.com', '0344076552', '360 Giải Phóng, Phường Phương Liệt, Quận Thanh Xuân, Hà Nội', 'tutai123', NULL, NULL, '2025-11-08 09:00:20'),
...
(2, 1, 'SF002', 'Sofa Góc L Shape', 'Sofa góc L cho phòng khách rộng, bọc nỉ cao cấp', 9093000.00, 'images/sofa_goc_L.jpg', 1, 0, 1, '2025-10-21 12:22:15'),
(3, 1, 'SF003', 'Ghế Đôn Milan', 'Ghế đôn nhỏ gọn, dùng làm ghế phụ', 315000.00, 'images/ghe_don.jpg', 0, 0, 1, '2025-10-21 12:22:15'),
...
(5, 1, 'SF005', 'Sofa Bed Tiện Dụng', 'Sofa có thể mở thành giường, đa năng', 5992000.00, 'images/sofa_bed.jpg', 1, 1, 1, '2025-10-21 12:22:15'),
...
(7, 2, 'BT002', 'Bộ Bàn Trà Scandi', 'Bàn trà phong cách Bắc Âu', 774000.00, 'images/ban_tra_scandi.jpg', 1, 0, 1, '2025-10-21 12:22:15'),
...
(9, 2, 'BT004', 'Bàn Trang Điểm Lily', 'Bàn trang điểm kèm gương, màu trắng', 1183000.00, 'images/ban_trang_diem.jpg', 0, 0, 1, '2025-10-21 12:22:15'),
(10, 2, 'BT005', 'Ghế Ăn Eames', 'Ghế ăn phong cách hiện đại, chân gỗ', 188500.00, 'images/ghe_eames.jpg', 0, 1, 1, '2025-10-21 12:22:15'),
(11, 2, 'BT006', 'Bàn Hộc Kéo Marco', 'Bàn phụ có hộc kéo tiện dụng', 980000.00, 'images/ban_hoc_keo.jpg', 0, 0, 0, '2025-10-21 12:22:15'),
(12, 2, 'BT007', 'Bàn Vi Tính Compact', 'Bàn vi tính nhỏ gọn, tiện lợi', 299500.00, 'images/ban_vi_tinh.jpg', 0, 1, 1, '2025-10-21 12:22:15'),
...
(14, 3, 'G02', 'Giường 1m2 Perfect', 'Giường nhỏ cho căn hộ 1-2 người', 3490000.00, 'images/giuong_1m2.jpg', 0, 0, 0, '2025-10-21 12:22:15'),
(15, 3, 'G03', 'Tấm Nệm Foam 20cm', 'Nệm foam 20cm êm ái, thoáng mát', 1642500.00, 'images/nem_foam.jpg', 0, 1, 1, '2025-10-21 12:22:15'),
(16, 3, 'G04', 'Bộ Giường + Tủ 1.2m', 'Set giường + tủ nhỏ gọn cho phòng bé', 6390000.00, 'images/giuong_tu.jpg', 1, 0, 0, '2025-10-21 12:22:15'),
(17, 3, 'G05', 'Đầu Giường Bọc Nỉ', 'Đầu giường bọc nỉ êm ái', 1290000.00, 'images/giuong_ngu_boc_ni.jpg', 0, 0, 0, '2025-10-21 12:22:15'),
(18, 3, 'G06', 'Giường tầng bé yêu', 'Giường tầng 2 tầng có cầu thang, phù hợp trẻ em', 709500.00, 'images/giuong_2_tang.jpg', 1, 1, 1, '2025-10-21 12:22:15'),
...
(20, 4, 'TU02', 'Tủ Trang Trí Kệ Modular', 'Tủ modular nhiều ngăn, hiện đại', 4290000.00, 'images/tu_modular.JPG', 0, 0, 0, '2025-10-21 12:22:15'),
(21, 4, 'TU03', 'Tủ giày 3 ngăn', 'Tủ giày nhỏ gọn, cửa gỗ màu sáng', 1290000.00, 'images/tu_giay.jpg', 0, 0, 0, '2025-10-21 12:22:15'),
(22, 4, 'KE01', 'Kệ Tivi Nordic', 'Kệ tivi phong cách Bắc Âu, đơn giản hiện đại', 1393000.00, 'images/tu_tivi.jpg', 0, 1, 1, '2025-10-21 12:22:15'),
...
(25, 5, 'TD01', 'Đèn Bàn Trang Trí', 'Đèn bàn LED trang trí, ánh sáng vàng ấm', 390000.00, 'images/den_led_de_ban.jpg', 1, 0, 0, '2025-10-21 12:22:15'),
...
--
ALTER TABLE `gio_hang`
  ADD CONSTRAINT `gio_hang_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `nguoi_dung` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `gio_hang_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `san_pham` (`id`) ON DELETE CASCADE;
